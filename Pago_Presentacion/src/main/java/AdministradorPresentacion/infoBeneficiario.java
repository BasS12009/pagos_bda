...
public class infoBeneficiario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Información Beneficiario");
        ...
        jPanel1.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 480, 180, 80));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(infoBeneficiario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new infoBeneficiario().setVisible(true);
            }
        });
    }
